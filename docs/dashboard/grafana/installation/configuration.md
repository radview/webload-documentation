...
The back-end has a number of configuration options that can be
specified in a `.ini` configuration file or specified using environment variables.

## Config file locations

- Default configuration from `C:\Program Files (x86)\RadView\WebLOAD\dashboard\grafana\conf\defaults.ini`
- Custom configuration from `C:\Program Files (x86)\RadView\WebLOAD\dashboard\grafana\confcustom.ini`
